...
public class Pendekar implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        System.out.println(self.getName() + ", sang pendekar, menyerang " + target.getName() + " dengan " + this.getSenjata());
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        if (target.isHidup()) {
            int amount = 40;
            System.out.println(self.getName() + " memukul mundur " + target.getName() + " dengan " + this.getPerisai());
            target.terimaSerangan(amount);
        } else {
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        if (target.isHidup()) {
            ...
            self.addHealth(30);
            self.addMana(20);
            System.out.println(self.getName() + " menyerang " + target.getName() + " dengan " + this.getSenjata() + " dan " + this.getPerisai());
